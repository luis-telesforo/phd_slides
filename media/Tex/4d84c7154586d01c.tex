...
\begin{align*}
\begin{tikzpicture}[scale=2]	\node (1) at (2,3)  {};	\node [white] (a) at (2.5,3.2) {};	\node (x) at (1,3)  {};	\node (0) at (2.2,2.5)  {};	\node [white] (b) at (1.5,2) {};	\node (z) at (3,2)  {};	\fill[gray,opacity=0.2](2,3)--(2.5,3.2)--(1,3)--(2,3);	\fill[black,opacity=0.2](2,3)--(1.5,2)--(1,3)--(2,3);	\fill[black,opacity=0.2](2,3)--(2.5,3.2)--(3,2)--(2,3);	\fill[gray,opacity=0.2](2,3)--(1.5,2)--(3,2)--(2,3);\end{tikzpicture}
\end{align*}
