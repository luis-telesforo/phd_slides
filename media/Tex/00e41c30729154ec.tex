...
\begin{align*}
\begin{tikzpicture}[scale=3]\node (1) at (2,3) {};\node [white] (a) at (2.5,3.2) {};\node (x) at (1,3) {};\node (0) at (2.2,2.5)  {};	\node [white] (b) at (1.5,2)  {};	\node (y) at (2.1,2.7)  {};	\node (z) at (3,2)  {};	\draw[opacity=0.2](x)--(b);	\draw[dotted](0)--(x);	\draw[opacity=0.2](x)--(a);	\draw (x)--(1);	\draw (x)--(1);	\draw (z)--(1);	\draw (z)--(a);	\draw[opacity=0.2](z)--(b);	\draw [dotted](0)--(z);	\draw[dotted](y)-- (a);\draw[dotted](y)-- (1);	\draw[dotted](y)-- (0);	\draw[dotted](y)-- (b);	\end{tikzpicture}
\end{align*}
